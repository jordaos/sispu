<?php
/**
 * TutsupMVC - Gerencia Models, controller e view
 *
 * @package TutsupMVC
 * @since 0.1
 */
class MVC{
	 ...
	 * @access private
	 */
	private $not_found = '/view/404.view.php';
	...
	public function __construct () {
		 ...
		 * controlador padrão (controller/home-controller.php) e chama o método index().
		 */
		if(!$this->controlador || $this->controlador == "HomeController"){
